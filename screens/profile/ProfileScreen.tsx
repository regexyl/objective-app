...
const DATA = [
  {
    id: "1",
    objectiveTitle:
      "Finish the 2020 ST Virtual Run of 17.5km within 1.5 hours.",
    duration: "3 months",
  ...
  },
  {
    id: "2",
    objectiveTitle:
      "Build a Python script to automate the conversion of file formats.",
    duration: "1 month",
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.cardContainer}>
        <TextBold style={styles.objectiveSectionHeader}>

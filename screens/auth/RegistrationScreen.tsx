...
const RegistrationScreen: React.FC<RegistrationScreenProps> = ({
  ...
  const onRegistration = () => {
    ...
    if (password === confirmPassword) {
      ...
      setPasswordWarning(
        <TextDefault style={styles.passwordWarning}>
      ...
      <View style={styles.screen}>
        <KeyboardAvoidingView>
          ...
          <View style={styles.inputContainer}>
            <InputField
              style={styles.input}
              onChangeText={updateNameVal}
              value={name}
              placeholder="Your name"
            />
            <InputField
              style={styles.input}
              onChangeText={updateEmailVal}
              value={email}
              placeholder="Email"
            ...
            <InputField
              ...
              onChangeText={updatePasswordVal}
              value={password}
          ...
          <ButtonOutline style={styles.createButton} onPress={onRegistration}>
            Create
          </ButtonOutline>
        </KeyboardAvoidingView>
      </View>
